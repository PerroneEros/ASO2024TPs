from classCuidador import Cuidador
...
class testerCuidador:
    ...
    def test():
        ...
        cuidador1.asignarMascota(mascota1)  # Juan asigna a Fido
        cuidador1.asignarMascota(mascota2)  # Juan asigna a Michi
        cuidador2.asignarMascota(mascota2)  # Maria asigna a Michi
